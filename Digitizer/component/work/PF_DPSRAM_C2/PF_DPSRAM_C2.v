//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Tue Apr 18 13:29:42 2023
...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of PF_DPSRAM_C2 to TCL
# Family: PolarFire
# Part Number: MPF300TS_ES-1FCG1152E
# Create and Configure the core component PF_DPSRAM_C2
create_and_configure_core -core_vlnv {Actel:SgCore:PF_DPSRAM:1.1.110} -component_name {PF_DPSRAM_C2} -params {\
"A_BLK_POLARITY:2"  \
"A_BYTE_ENABLE_WIDTH:8"  \
"A_CLK_EDGE:RISE"  \
"A_DEPTH:1024"  \
...
"RWB_PN:B_WEN"  \
"SII_LOCK:0"   }
# Exporting Component Description of PF_DPSRAM_C2 to TCL done
*/
...
// Component instances
//--------------------------------------------------------------------
//--------PF_DPSRAM_C2_PF_DPSRAM_C2_0_PF_DPSRAM   -   Actel:SgCore:PF_DPSRAM:1.1.110
PF_DPSRAM_C2_PF_DPSRAM_C2_0_PF_DPSRAM PF_DPSRAM_C2_0(
        // Inputs
        .A_WEN      ( A_WEN ),
        .B_WEN      ( B_WEN ),
        .CLK        ( CLK ),

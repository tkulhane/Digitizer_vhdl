//////////////////////////////////////////////////////////////////////
// Created by SmartDesign Tue Apr  9 16:59:48 2024
...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of PF_XCVR_ERM_C9 to TCL
# Family: PolarFire
# Part Number: MPF300TS_ES-1FCG1152E
# Create and Configure the core component PF_XCVR_ERM_C9
create_and_configure_core -core_vlnv {Actel:SystemBuilder:PF_XCVR_ERM:3.1.200} -component_name {PF_XCVR_ERM_C9} -params {\
...
"XT_ES_DEVICE:true" }
# Exporting Component Description of PF_XCVR_ERM_C9 to TCL done
*/

// PF_XCVR_ERM_C9
module PF_XCVR_ERM_C9(
    // Inputs
    CTRL_ARST_N,
    CTRL_CLK,
    LANE0_CDR_REF_CLK_0,
...
wire          LANE0_DRI_ARST_N;
wire          LANE0_DRI_CLK;
wire   [10:0] LANE0_DRI_CTRL;
wire          LANE0_DRI_SLAVE_DRI_INTERRUPT;
wire   [32:0] LANE0_DRI_SLAVE_DRI_RDATA;
wire   [32:0] LANE0_DRI_WDATA;
wire          LANE0_LOS;
...
wire   [32:0] LANE0_DRI_SLAVE_DRI_RDATA_net_0;
wire          LANE0_DRI_SLAVE_DRI_INTERRUPT_net_0;
...
assign LANE0_DRI_SLAVE_DRI_RDATA_net_0     = LANE0_DRI_SLAVE_DRI_RDATA;
assign LANE0_DRI_RDATA[32:0]               = LANE0_DRI_SLAVE_DRI_RDATA_net_0;
assign LANE0_DRI_SLAVE_DRI_INTERRUPT_net_0 = LANE0_DRI_SLAVE_DRI_INTERRUPT;
assign LANE0_DRI_INTERRUPT                 = LANE0_DRI_SLAVE_DRI_INTERRUPT_net_0;
...
//--------PF_XCVR_ERM_C9_I_XCVR_PF_XCVR   -   Actel:SgCore:PF_XCVR:2.1.101
PF_XCVR_ERM_C9_I_XCVR_PF_XCVR I_XCVR(
        // Inputs
        ...
        .LANE0_DRI_CLK        ( LANE0_DRI_CLK ),
        .LANE0_DRI_WDATA      ( LANE0_DRI_WDATA ),
        .LANE0_DRI_ARST_N     ( LANE0_DRI_ARST_N ),
        .LANE0_DRI_CTRL       ( LANE0_DRI_CTRL ),
        ...
        .LANE0_DRI_RDATA      ( LANE0_DRI_SLAVE_DRI_RDATA ),
        .LANE0_DRI_INTERRUPT  ( LANE0_DRI_SLAVE_DRI_INTERRUPT ),

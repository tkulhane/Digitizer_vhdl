...
vlog "+incdir+${PROJECT_DIR}/component/Actel/DirectCore/CORELANEMSTR/2.1.100/rtl/vlog/core" -sv -work presynth "${PROJECT_DIR}/component/work/PF_CLK_DIV_C1/PF_CLK_DIV_C1_0/PF_CLK_DIV_C1_PF_CLK_DIV_C1_0_PF_CLK_DIV.v"
vlog "+incdir+${PROJECT_DIR}/component/Actel/DirectCore/CORELANEMSTR/2.1.100/rtl/vlog/core" -sv -work presynth "${PROJECT_DIR}/component/work/PF_CLK_DIV_C1/PF_CLK_DIV_C1.v"
